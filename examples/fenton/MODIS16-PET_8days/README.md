...
## 1. Request Parameters  
    ...
    Name: Fenton River Basin  

    Date Completed: 2026-02-16T16:38:00.676187  

    ID: 99b11194-7022-4c36-a778-b07f768ab20b  

    Details:  

        Input Vector Name:            Watershed_Fenton/Watershed_Fenton
        Number of Vector Features:    4  
        ...
        Layers:  
                ...
                PET_500m (MOD16A2GF.061)  
      
        Output Projection:            Native Projection
        Output Format:                netcdf4  

    Version: This request was processed by AppEEARS version 3.110  

## 2. Request File Listing  

**Supporting Files:**  

- Fenton-River-Basin-MOD16A2GF-061-metadata.xml
- Fenton-River-Basin-granule-list.txt
- Fenton-River-Basin-request.json
- MOD16A2GF-061-ET-QC-500m-lookup.csv
- MOD16A2GF-061-ET-QC-500m-Statistics-QA.csv
- MOD16A2GF-061-Statistics.csv

**Data Files:**  

Number of Extracted Data Files: 4  
Total Size of Extracted Data Files: 1.03 MB  
...
- Shi, X. (2026). Hetao Irrigation District Data and Processing Scripts (v 1.0). Zenodo. https://doi.org/10.5281/ZENODO.18298674

Shi, X. (2026). Hetao Irrigation District Data and Processing Scripts (v 1.0). Zenodo. https://doi.org/10.5281/ZENODO.18298675

Running, S., Mu, Q., Zhao, M., & Moreno, A. (2021). MODIS/Terra Net Evapotranspiration Gap-Filled 8-Day L4 Global 500m SIN Grid V061. NASA Land Processes Distributed Active Archive Center. https://doi.org/10.5067/MODIS/MOD16A2GF.061. Accessed February 16, 2026.

## 10. Software Citation  

AppEEARS Team. (2026). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 3.110. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed February 16, 2026. https://appeears.earthdatacloud.nasa.gov
